  ...
  return (
    <>
      ...
      <Background>
        ...
        <ImageCard image="img/모터시티.png" time="8 mins" fontSize="13px">
          여기는 모터시티바이매니멀잠실점입니다!
          <br />
          피자 진짜 맛있어요...❤
          <br />
        ...
        <ImageCard image="img/궁전다방.png" time="3 mins" fontSize="12px">
          좌식 카페 좋아하시는 분~✋ <br />
        ...
        <ImageCard image="img/로우머.png" time="3 mins" fontSize="13px">
